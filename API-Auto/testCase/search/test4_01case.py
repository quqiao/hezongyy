...
login_xls = readExcel.readExcel().get_xls('商品搜索API.xlsx', '1关键字条件搜索')

@paramunittest.parametrized(*login_xls)
class testSettleOnCondition(unittest.TestCase):
    ...
    def checkResult(self):  # 断言
        ...
        if self.case_name == 'keyWords为空':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为默认排序':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为点击量':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为销售量':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为价格':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为商品名称':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为厂家名称':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为创建时间':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortType为错误':
            self.assertEqual(ss['code'], '900007')
        if self.case_name == 'sortType为空':
            self.assertEqual(ss['code'], '900007')
        if self.case_name == 'sortOrder为升序':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortOrder为降序':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'sortOrder为错误':
            self.assertEqual(ss['code'], '900007')
        if self.case_name == 'sortOrder为空':
            self.assertEqual(ss['code'], '900007')
        if self.case_name == 'pageNumber为0':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageNumber为10':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageNumber为100':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageNumber为空':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageSize为0':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageSize为20':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageSize为200':
            self.assertEqual(ss['code'], '000000')
        if self.case_name == 'pageSize为空':
            self.assertEqual(ss['code'], '000000')
