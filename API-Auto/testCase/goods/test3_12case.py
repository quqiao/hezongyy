...
login_xls = readExcel.readExcel().get_xls('商品.xlsx', '12根据商品ID和数量返回对应的阶梯价格')
...
class testGoodsTieredPricingQuantity(unittest.TestCase):
    ...
    def checkResult(self):  # 断言
        ...
        if self.case_name == 'id为空':  # 同上
            self.assertEqual(ss['code'], "000000")
        if self.case_name == 'quantity正确':  # 同上
            self.assertEqual(ss['code'], "000000")
