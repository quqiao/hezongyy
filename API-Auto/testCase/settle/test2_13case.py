...
login_xls = readExcel.readExcel().get_xls('购物车与结算.xlsx', '13是否完成支付')
...
class testSettlePayResult(unittest.TestCase):
    ...
    def checkResult(self):  # 断言
        ...
        if self.case_name == 'orderId填写正确':  # 如果case_name是login，说明合法，返回的code应该为200
